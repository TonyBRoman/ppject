document.addEventListener("DOMContentLoaded", () => {
    const codes = {
        ...
        "25739": "¡Insolentes! ¡No puedo creer que hayan logrado avanzar tanto!<br>Pero no se engañen, lo peor aun esta por venir.<br>Hare todo lo posible para detenerlos y asegurarme de que<br>nunca encuentren el objeto final ¡No saldrán de Oz tan fácilmente!<br><br><br>Donde el sol se oculta al final del día,<br>un rompecabezas circular te espera en la penumbra fría.<br>Gira las letras en su esfera sin fin, conecta las palabras<br>y descubre el misterio en su confin. Al resolver este enigma<br>de círculo y arte, revelarás el sendero hacia la siguiente parte.",
